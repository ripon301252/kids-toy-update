...
const Signup = () => {
  ...
  return (
    <div className="flex justify-center items-center md:min-h-screen py-5 px-4">
      ...
      <div className="card w-full max-w-md backdrop-blur-lg bg-white/10 shadow-2xl rounded-2xl p-6 border border-gray-200">
        ...
        <form onSubmit={handleSignup} className="space-y-3">
          ...
          <button
            type="submit"
            className="btn bg-[#001931] text-white font-semibold w-full mt-4 hover:opacity-90 hover:scale-105 transition-transform border-none shadow-none"
          >
            Sign Up
          </button>
