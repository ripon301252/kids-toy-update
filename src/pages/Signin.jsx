...
const Signin = () => {
  ...
  return (
    <div className="md:min-h-screen py-5 flex items-center justify-center px-4">
      ...
      <div className="card w-full max-w-md backdrop-blur-lg bg-white/10 shadow-2xl border border-white/50 rounded-2xl p-8">
        ...
        <form onSubmit={handleSignin} className="space-y-4">
          ...
          <button
            type="submit"
            className="btn w-full bg-[#001931] text-white font-semibold hover:scale-105 transition-transform border-none shadow-none"
          >
            Sign In
          </button>
